...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/branch-health', icon: GitBranch, label: 'Branch Health' },
      { to: '/prompt-efficiency', icon: Brain, label: 'Prompt Efficiency' },
      { to: '/workflow-bottlenecks', icon: GitBranch, label: 'Workflow Bottlenecks' },
